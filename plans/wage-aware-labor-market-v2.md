...
- **Phases 4b (full unification + hysteresis + survival override), 5b, 6 — deferred.** Single argmax across all professions, explicit hysteresis + survival override, Apprentice/Healer + apprenticeship lifecycle, HTN scorer/UI — pending follow-up sessions.
