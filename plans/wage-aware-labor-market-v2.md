...
- **Phases 4b (full unification + hysteresis + survival override), 5b–7 — deferred.** Single argmax across all professions, explicit hysteresis + survival override, Apprentice/Healer, HTN scorer/UI, docs — pending follow-up sessions.
