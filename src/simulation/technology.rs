...
pub static TECH_TREE: [TechDef; TECH_COUNT] = [
    // ── Paleolithic ───────────────────────────────────────────────────────────
    TechDef {
        id: FIRE_MAKING, era: Era::Paleolithic,
        name: "Fire Making",
        description: "Control of fire enables cooking, warmth, light, and protection.",
        prerequisites: &[],
        triggers: &[
            TechTrigger { activity: ActivityKind::Foraging,  per_unit_chance: 0.001 },
            TechTrigger { activity: ActivityKind::Combat,    per_unit_chance: 0.001 },
        ],
        bonus: TechBonus { food_yield_bonus: 0.10, food_storage_bonus: 0.20, ..TechBonus::ZERO },
    },
    TechDef {
        id: FLINT_KNAPPING, era: Era::Paleolithic,
        name: "Flint Knapping",
        description: "Shaping flint and obsidian into sharp tools and projectile points.",
        prerequisites: &[FIRE_MAKING],
        triggers: &[
            TechTrigger { activity: ActivityKind::StoneMining, per_unit_chance: 0.003 },
            TechTrigger { activity: ActivityKind::Combat,      per_unit_chance: 0.002 },
        ],
        bonus: TechBonus { stone_yield_bonus: 0.10, combat_damage_bonus: 1, ..TechBonus::ZERO },
    },
    TechDef {
        id: HUNTING_SPEAR, era: Era::Paleolithic,
        name: "Hunting Spear",
        description: "Hafted stone-tipped spears allow pursuit of large game.",
        prerequisites: &[FLINT_KNAPPING],
        triggers: &[
            TechTrigger { activity: ActivityKind::Combat,   per_unit_chance: 0.004 },
            TechTrigger { activity: ActivityKind::Foraging, per_unit_chance: 0.002 },
        ],
        bonus: TechBonus { food_yield_bonus: 0.15, combat_damage_bonus: 2, ..TechBonus::ZERO },
    },
    TechDef {
        id: FOOD_SMOKING, era: Era::Paleolithic,
        name: "Food Smoking",
        description: "Smoking meat and fish over fire greatly extends their preservation.",
        prerequisites: &[FIRE_MAKING],
        triggers: &[
            TechTrigger { activity: ActivityKind::Foraging, per_unit_chance: 0.003 },
            TechTrigger { activity: ActivityKind::Farming,  per_unit_chance: 0.001 },
        ],
        bonus: TechBonus { food_yield_bonus: 0.20, food_storage_bonus: 0.30, ..TechBonus::ZERO },
    },
    TechDef {
        id: BONE_TOOLS, era: Era::Paleolithic,
        name: "Bone Tools",
        description: "Animal bones fashioned into needles, awls, and hooks.",
        prerequisites: &[FLINT_KNAPPING],
        triggers: &[
            TechTrigger { activity: ActivityKind::Foraging,    per_unit_chance: 0.003 },
            TechTrigger { activity: ActivityKind::StoneMining, per_unit_chance: 0.002 },
        ],
        bonus: TechBonus {
            food_yield_bonus: 0.05, wood_yield_bonus: 0.05, stone_yield_bonus: 0.05,
            ..TechBonus::ZERO
        },
    },
    TechDef {
        id: OCHRE_PAINTING, era: Era::Paleolithic,
        name: "Ochre Painting",
        description: "Red ochre pigment used in ritual and symbolic expression.",
        prerequisites: &[FIRE_MAKING],
        triggers: &[
            TechTrigger { activity: ActivityKind::Socializing, per_unit_chance: 0.004 },
        ],
    ...
    // ── Mesolithic ────────────────────────────────────────────────────────────
    TechDef {
        id: BOW_AND_ARROW, era: Era::Mesolithic,
        name: "Bow and Arrow",
        description: "Flexible bows and light arrows extend hunting range dramatically.",
        prerequisites: &[HUNTING_SPEAR],
        triggers: &[
            TechTrigger { activity: ActivityKind::Combat,        per_unit_chance: 0.003 },
            TechTrigger { activity: ActivityKind::WoodGathering, per_unit_chance: 0.002 },
        ],
        bonus: TechBonus { food_yield_bonus: 0.20, combat_damage_bonus: 3, ..TechBonus::ZERO },
    },
    TechDef {
        id: FISHING, era: Era::Mesolithic,
        name: "Fishing",
        description: "Woven baskets, hooks, and weirs to harvest fish from rivers.",
        prerequisites: &[BONE_TOOLS],
        triggers: &[
            TechTrigger { activity: ActivityKind::Foraging,   per_unit_chance: 0.004 },
            TechTrigger { activity: ActivityKind::Socializing, per_unit_chance: 0.001 },
        ],
        bonus: TechBonus { food_yield_bonus: 0.25, food_storage_bonus: 0.10, ..TechBonus::ZERO },
    },
    TechDef {
        id: MICROLITHIC_TOOLS, era: Era::Mesolithic,
        name: "Microlithic Tools",
        description: "Tiny precisely-knapped blades set in handles for composite tools.",
        prerequisites: &[FLINT_KNAPPING],
        triggers: &[
            TechTrigger { activity: ActivityKind::StoneMining, per_unit_chance: 0.004 },
            TechTrigger { activity: ActivityKind::Foraging,    per_unit_chance: 0.002 },
        ],
        bonus: TechBonus {
            food_yield_bonus: 0.05, wood_yield_bonus: 0.10, stone_yield_bonus: 0.10,
            combat_damage_bonus: 1, ..TechBonus::ZERO
        },
    },
    TechDef {
        id: DOG_DOMESTICATION, era: Era::Mesolithic,
        ...
        triggers: &[
            TechTrigger { activity: ActivityKind::Foraging,   per_unit_chance: 0.002 },
            TechTrigger { activity: ActivityKind::Socializing, per_unit_chance: 0.003 },
        ],
        bonus: TechBonus { food_yield_bonus: 0.15, combat_damage_bonus: 1, ..TechBonus::ZERO },
    },
    TechDef {
        id: LOG_RAFT, era: Era::Mesolithic,
        name: "Log Raft",
        description: "Bound logs enable water travel and access to new territories.",
        prerequisites: &[BONE_TOOLS],
        triggers: &[
            TechTrigger { activity: ActivityKind::WoodGathering, per_unit_chance: 0.005 },
            TechTrigger { activity: ActivityKind::Foraging,      per_unit_chance: 0.001 },
        ],
        bonus: TechBonus { food_yield_bonus: 0.10, ..TechBonus::ZERO },
    },
    TechDef {
        id: DRIED_MEAT, era: Era::Mesolithic,
        name: "Dried Meat",
        description: "Sun-drying and salting meat creates portable, long-lasting food.",
        prerequisites: &[FOOD_SMOKING],
        triggers: &[
            TechTrigger { activity: ActivityKind::Foraging, per_unit_chance: 0.003 },
            TechTrigger { activity: ActivityKind::Farming,  per_unit_chance: 0.002 },
        ],
        bonus: TechBonus { food_yield_bonus: 0.20, food_storage_bonus: 0.20, ..TechBonus::ZERO },
    },

    // ── Neolithic ─────────────────────────────────────────────────────────────
    TechDef {
        id: CROP_CULTIVATION, era: Era::Neolithic,
        ...
        triggers: &[
            TechTrigger { activity: ActivityKind::Farming,  per_unit_chance: 0.005 },
            TechTrigger { activity: ActivityKind::Foraging, per_unit_chance: 0.001 },
        ],
        bonus: TechBonus { food_yield_bonus: 0.35, food_storage_bonus: 0.15, ..TechBonus::ZERO },
    },
    TechDef {
        id: ANIMAL_HUSBANDRY, era: Era::Neolithic,
        name: "Animal Husbandry",
        description: "Selective breeding of sheep, goats, and cattle for sustained yields.",
        prerequisites: &[DOG_DOMESTICATION],
        triggers: &[
            TechTrigger { activity: ActivityKind::Farming,    per_unit_chance: 0.003 },
            TechTrigger { activity: ActivityKind::Socializing, per_unit_chance: 0.002 },
        ],
        bonus: TechBonus { food_yield_bonus: 0.25, food_storage_bonus: 0.10, ..TechBonus::ZERO },
    },
    TechDef {
        id: FIRED_POTTERY, era: Era::Neolithic,
        name: "Fired Pottery",
        ...
        triggers: &[
            TechTrigger { activity: ActivityKind::Farming,    per_unit_chance: 0.003 },
            TechTrigger { activity: ActivityKind::StoneMining, per_unit_chance: 0.001 },
        ],
        bonus: TechBonus { food_yield_bonus: 0.10, food_storage_bonus: 0.40, ..TechBonus::ZERO },
    },
    TechDef {
        id: LOOM_WEAVING, era: Era::Neolithic,
        name: "Loom Weaving",
        description: "Frame looms produce cloth from plant fibers and wool.",
        prerequisites: &[CROP_CULTIVATION],
        triggers: &[
            TechTrigger { activity: ActivityKind::Farming,  per_unit_chance: 0.003 },
            TechTrigger { activity: ActivityKind::Trading,  per_unit_chance: 0.002 },
        ],
        bonus: TechBonus::ZERO,
    },
    TechDef {
        id: SADDLE_QUERN, era: Era::Neolithic,
        name: "Saddle Quern",
        ...
        triggers: &[
            TechTrigger { activity: ActivityKind::Farming,    per_unit_chance: 0.004 },
            TechTrigger { activity: ActivityKind::StoneMining, per_unit_chance: 0.002 },
        ],
        bonus: TechBonus { food_yield_bonus: 0.20, food_storage_bonus: 0.15, ..TechBonus::ZERO },
    },
    TechDef {
        id: PERM_SETTLEMENT, era: Era::Neolithic,
        ...
        bonus: TechBonus { food_yield_bonus: 0.10, food_storage_bonus: 0.30, ..TechBonus::ZERO },
    },
    TechDef {
        id: GRANARY, era: Era::Neolithic,
        name: "Granary",
        ...
        bonus: TechBonus { food_storage_bonus: 0.50, ..TechBonus::ZERO },
    },
    TechDef {
        id: IRRIGATION, era: Era::Neolithic,
        name: "Irrigation",
        ...
        bonus: TechBonus { food_yield_bonus: 0.40, ..TechBonus::ZERO },
    },
    TechDef {
        id: FERMENTATION, era: Era::Neolithic,
        name: "Fermentation",
        ...
        bonus: TechBonus { food_yield_bonus: 0.10, food_storage_bonus: 0.25, ..TechBonus::ZERO },
    },
    TechDef {
        id: DUGOUT_CANOE, era: Era::Neolithic,
        name: "Dugout Canoe",
    ...
    // ── Chalcolithic ──────────────────────────────────────────────────────────
    TechDef {
        id: COPPER_WORKING, era: Era::Chalcolithic,
        name: "Copper Working",
        ...
        triggers: &[
            TechTrigger { activity: ActivityKind::StoneMining, per_unit_chance: 0.004 },
            TechTrigger { activity: ActivityKind::IronMining,  per_unit_chance: 0.003 },
        ],
        bonus: TechBonus { stone_yield_bonus: 0.10, combat_damage_bonus: 2, ..TechBonus::ZERO },
    },
    TechDef {
        id: COPPER_TOOLS, era: Era::Chalcolithic,
        name: "Copper Tools",
        ...
        bonus: TechBonus {
            food_yield_bonus: 0.10, wood_yield_bonus: 0.10, stone_yield_bonus: 0.15,
            combat_damage_bonus: 1, ..TechBonus::ZERO
        },
    },
    TechDef {
        id: POTTERS_WHEEL, era: Era::Chalcolithic,
        name: "Potter's Wheel",
        description: "Rotating platform allows rapid, uniform pottery production.",
        prerequisites: &[FIRED_POTTERY, COPPER_WORKING],
        triggers: &[
            TechTrigger { activity: ActivityKind::Farming,  per_unit_chance: 0.002 },
            TechTrigger { activity: ActivityKind::Trading,  per_unit_chance: 0.003 },
        ],
        bonus: TechBonus { food_storage_bonus: 0.20, ..TechBonus::ZERO },
    },
    TechDef {
        id: OX_CART, era: Era::Chalcolithic,
        name: "Ox Cart",
        description: "Wheeled carts pulled by oxen transform bulk transport of goods.",
        prerequisites: &[ANIMAL_HUSBANDRY, COPPER_TOOLS],
        triggers: &[
            TechTrigger { activity: ActivityKind::Farming,  per_unit_chance: 0.002 },
            TechTrigger { activity: ActivityKind::Trading,  per_unit_chance: 0.004 },
        ],
        bonus: TechBonus { food_yield_bonus: 0.15, food_storage_bonus: 0.10, ..TechBonus::ZERO },
    },
    TechDef {
        id: ARD_PLOW, era: Era::Chalcolithic,
        name: "Ard Plow",
        description: "Ox-drawn ard breaks soil faster, enabling far larger cultivated areas.",
        prerequisites: &[ANIMAL_HUSBANDRY, COPPER_TOOLS],
        triggers: &[
            TechTrigger { activity: ActivityKind::Farming,    per_unit_chance: 0.006 },
            TechTrigger { activity: ActivityKind::StoneMining, per_unit_chance: 0.001 },
        ],
        bonus: TechBonus { food_yield_bonus: 0.35, ..TechBonus::ZERO },
    },
    TechDef {
        id: LONG_DIST_TRADE, era: Era::Chalcolithic,
        ...
        triggers: &[
            TechTrigger { activity: ActivityKind::Trading,    per_unit_chance: 0.007 },
            TechTrigger { activity: ActivityKind::Socializing, per_unit_chance: 0.002 },
        ],
        bonus: TechBonus::ZERO,
    },
    TechDef {
        id: TALLY_MARKS, era: Era::Chalcolithic,
        name: "Tally Marks",
        description: "Notched bones and clay tokens record quantities and debts.",
        prerequisites: &[LONG_DIST_TRADE],
        triggers: &[
            TechTrigger { activity: ActivityKind::Trading,    per_unit_chance: 0.005 },
            TechTrigger { activity: ActivityKind::Socializing, per_unit_chance: 0.003 },
        ],
        bonus: TechBonus { food_storage_bonus: 0.10, ..TechBonus::ZERO },
    },
    TechDef {
        id: SACRED_RITUAL, era: Era::Chalcolithic,
        name: "Sacred Ritual",
        description: "Organised ceremony and burial rites bind communities spiritually.",
        prerequisites: &[OCHRE_PAINTING, FERMENTATION],
        triggers: &[
            TechTrigger { activity: ActivityKind::Socializing, per_unit_chance: 0.006 },
            TechTrigger { activity: ActivityKind::Farming,     per_unit_chance: 0.001 },
        ],
        bonus: TechBonus { food_yield_bonus: 0.05, food_storage_bonus: 0.15, ..TechBonus::ZERO },
    },

    // ── Bronze Age ────────────────────────────────────────────────────────────
    TechDef {
        id: TIN_PROSPECTING, era: Era::BronzeAge,
        ...
        triggers: &[
            TechTrigger { activity: ActivityKind::StoneMining, per_unit_chance: 0.004 },
            TechTrigger { activity: ActivityKind::CoalMining,  per_unit_chance: 0.004 },
        ],
        bonus: TechBonus { stone_yield_bonus: 0.10, ..TechBonus::ZERO },
    },
    TechDef {
        id: BRONZE_CASTING, era: Era::BronzeAge,
        name: "Bronze Casting",
        ...
        triggers: &[
            TechTrigger { activity: ActivityKind::StoneMining, per_unit_chance: 0.003 },
            TechTrigger { activity: ActivityKind::CoalMining,  per_unit_chance: 0.005 },
            TechTrigger { activity: ActivityKind::IronMining,  per_unit_chance: 0.003 },
        ],
        bonus: TechBonus { stone_yield_bonus: 0.10, combat_damage_bonus: 2, ..TechBonus::ZERO },
    },
    TechDef {
        id: BRONZE_TOOLS, era: Era::BronzeAge,
        name: "Bronze Tools",
        ...
        bonus: TechBonus {
            food_yield_bonus: 0.15, wood_yield_bonus: 0.20, stone_yield_bonus: 0.20,
            ..TechBonus::ZERO
        },
    },
    TechDef {
        id: BRONZE_WEAPONS, era: Era::BronzeAge,
        name: "Bronze Weapons",
        ...
        bonus: TechBonus { combat_damage_bonus: 4, ..TechBonus::ZERO },
    },
    TechDef {
        id: SCALE_ARMOR, era: Era::BronzeAge,
        name: "Scale Armor",
    ...
    TechDef {
        id: HORSE_TAMING, era: Era::BronzeAge,
        name: "Horse Taming",
        ...
        bonus: TechBonus { food_yield_bonus: 0.20, combat_damage_bonus: 1, ..TechBonus::ZERO },
    },
    TechDef {
        id: HORSEBACK_RIDING, era: Era::BronzeAge,
        name: "Horseback Riding",
        description: "Mounted warriors and herders gain speed and reach unprecedented in warfare.",
        prerequisites: &[HORSE_TAMING],
        triggers: &[
            TechTrigger { activity: ActivityKind::Combat,   per_unit_chance: 0.005 },
            TechTrigger { activity: ActivityKind::Foraging, per_unit_chance: 0.001 },
        ],
        bonus: TechBonus { food_yield_bonus: 0.10, combat_damage_bonus: 2, ..TechBonus::ZERO },
    },
    TechDef {
        id: WAR_CHARIOT, era: Era::BronzeAge,
        name: "War Chariot",
        ...
        triggers: &[
            TechTrigger { activity: ActivityKind::Combat, per_unit_chance: 0.006 },
        ],
        bonus: TechBonus { combat_damage_bonus: 5, ..TechBonus::ZERO },
    },
    TechDef {
        id: CUNEIFORM_WRITING, era: Era::BronzeAge,
    ...
    TechDef {
        id: CITY_STATE_ORG, era: Era::BronzeAge,
        ...
        triggers: &[
            TechTrigger { activity: ActivityKind::Socializing, per_unit_chance: 0.005 },
            TechTrigger { activity: ActivityKind::Trading,     per_unit_chance: 0.003 },
        ],
        bonus: TechBonus { food_yield_bonus: 0.10, food_storage_bonus: 0.30, ..TechBonus::ZERO },
    },
    TechDef {
        id: PROFESSIONAL_ARMY, era: Era::BronzeAge,
        ...
        triggers: &[
            TechTrigger { activity: ActivityKind::Combat,      per_unit_chance: 0.007 },
            TechTrigger { activity: ActivityKind::Socializing,  per_unit_chance: 0.002 },
        ],
        bonus: TechBonus { combat_damage_bonus: 3, ..TechBonus::ZERO },
    },
    TechDef {
        id: MONUMENTAL_BUILDING, era: Era::BronzeAge,
        ...
        triggers: &[
            TechTrigger { activity: ActivityKind::WoodGathering, per_unit_chance: 0.003 },
            TechTrigger { activity: ActivityKind::StoneMining,   per_unit_chance: 0.005 },
        ],
        bonus: TechBonus { stone_yield_bonus: 0.20, food_storage_bonus: 0.20, ..TechBonus::ZERO },
    },
    TechDef {
        id: LUNAR_CALENDAR, era: Era::BronzeAge,
        name: "Lunar Calendar",
        description: "Systematic observation of moon phases creates a shared agricultural calendar.",
        prerequisites: &[CUNEIFORM_WRITING, SACRED_RITUAL],
        triggers: &[
            TechTrigger { activity: ActivityKind::Socializing, per_unit_chance: 0.004 },
            TechTrigger { activity: ActivityKind::Farming,     per_unit_chance: 0.002 },
        ],
        bonus: TechBonus { food_yield_bonus: 0.10, food_storage_bonus: 0.10, ..TechBonus::ZERO },
    },
];
...
pub fn tech_discovery_system(
    ...
    if calendar.season == *last_season { return; }
    *last_season = calendar.season;
    ...
    for (faction_id, faction) in registry.factions.iter_mut() {
        ...
        for def in TECH_TREE.iter() {
            if faction.techs.has(def.id) { continue; }
            if def.prerequisites.iter().any(|&p| !faction.techs.has(p)) { continue; }
        ...
        for id in to_unlock {
            info!("Faction {} discovered: {} ({})", faction_id, tech_def(id).name, tech_def(id).era.name());
