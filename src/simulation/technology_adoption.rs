...
use crate::simulation::technology::{
    ...
    FIRED_POTTERY, FIRE_MAKING, FISHING, FLINT_KNAPPING, FOOD_SMOKING, GRANARY, HORSEBACK_RIDING,
    HORSE_TAMING, HUNTING_SPEAR, IRRIGATION, LOG_RAFT, LONG_DIST_TRADE, LOOM_WEAVING,
