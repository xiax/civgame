...
impl Chunk {
    ...
    pub fn delta(&self, lx: usize, ly: usize, z_local: usize) -> Option<TileData> {
        self.deltas.get(&(lx as u8, ly as u8, z_local as u8)).copied()
    }
    ...
    pub fn set_delta(&mut self, lx: usize, ly: usize, z: i32, data: TileData) {
        ...
        self.deltas.insert((lx as u8, ly as u8, z_local as u8), data);
...
impl ChunkMap {
    ...
    pub fn passable_step(&self, tx: i32, ty: i32, ntx: i32, nty: i32) -> bool {
        ...
        if src_z < Z_MIN || dst_z < Z_MIN { return false; }
        let dz = dst_z - src_z;
...
mod tests {
    ...
    fn chunk_delta_roundtrip() {
        ...
        let data = TileData { kind: TileKind::Wall, ..Default::default() };
    ...
    fn surface_tile_kind_respects_delta() {
        ...
        chunk.set_delta(5, 3, 0, TileData { kind: TileKind::Wall, ..Default::default() });
